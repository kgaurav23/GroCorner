package `in`.grocorner.view.product_detail.fragment

import `in`.grocorner.R
import `in`.grocorner.view.product_detail.adapter.ProductsMayLikeAdapter
import `in`.grocorner.view.product_detail.adapter.ReviewsAdapter
import `in`.grocorner.model.network.pojo.ProductsMayLikeModel
import `in`.grocorner.model.network.pojo.ReviewsModel
